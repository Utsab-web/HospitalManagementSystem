document.addEventListener("DOMContentLoaded", () => {
    ...
    addMedicineBtn.addEventListener("click", () => {
        ...
        row.innerHTML = `
            ...
            <td class="p-2">
                <input type="text" placeholder="1 Tablet" aria-label="Dose"
                       class="w-full rounded-lg border border-emerald-300 px-3 py-2 outline-none">
            </td>
            <td class="p-2 text-center">
                <input type="checkbox" aria-label="Morning dose">
            </td>
            <td class="p-2 text-center">
                <input type="checkbox" aria-label="Afternoon dose">
            </td>
            <td class="p-2 text-center">
                <input type="checkbox" aria-label="Evening dose">
            </td>
            <td class="p-2">
                <input type="number" min="1" placeholder="Days" aria-label="Number of days"
